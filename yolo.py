...
'''
batch norm decay and epsilon for batch normalization 
normalization helps train model faster and reduces variance
moving_average = momentum * moving_average + (1 - momentum) * current_average
'''
batch_norm_decay = 0.9      # refers to momemtum in normalization formula (compute moving avg. and var)
batch_norm_epsilon = 1e-05  # refers to epsilon in formula
leaky_ReLU = 0.1            # refers to alpha

''' anchors are bounding boxes priors that were calculated on COCO dataset using k-means clustering
    we predict width and height of the box as offsets from cluster centroids 
'''
anchors = [(10, 13), (16, 30), (33, 23), (30, 61), (62, 45), (59, 119), (116, 90), (156, 198), (373, 326)]
model_size = (416, 416)     # input size of the model
...
def fixed_padding(inputs, kernel_size, data_format):
    # YOLO uses conv with fixed padding (means padding is defined by kernel size)
...
if __name__ == '__main__':
    ...
    model = Yolo_v3(n_classes=n_classes, model_size=model_size,
